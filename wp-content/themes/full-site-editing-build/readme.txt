=== Fancy Squares - Base w/ wordpress-scripts ===
Contributors: Rory Heaney
Tested up to: 6.4
...
- Src. Images, SCSS files and JS files.
...
== Licence ==
Fancy Squares - Base is distributed under the terms of the GNU GPL.
